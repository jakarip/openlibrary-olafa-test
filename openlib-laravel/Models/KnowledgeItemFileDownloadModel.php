...
class KnowledgeItemFileDownloadModel extends Model
{
    use HasFactory;

    protected $table = 'knowledge_item_file_download';
    ...
    // Static methods
    public static function logDownload($knowledgeItemId, $memberId, $fileName)
    {
        return self::create([
    ...
    public static function getMemberDownloadHistory($memberId, $limit = 50)
    {
