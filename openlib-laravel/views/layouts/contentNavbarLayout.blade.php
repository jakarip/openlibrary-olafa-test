                    ...
                    <div class="row mb-4">
                        <div class="col-sm-6 align-items-center">
                            <div class="d-flex justify-content-start align-self-center">
                                ...
                                <div>
                                    ...
                                    <div class="small text-muted" style="line-height: 1"><a href="" style="text-decoration:none" class="text-danger">Back to Home</a></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 justify-content-end d-flex ytitle-left">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="">
                                    <h6 class="mb-0" style="line-height: 1">10 Maret 2023</h6>
