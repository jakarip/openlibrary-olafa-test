...
<div class="card">
    <div class="card-header sticky-element bg-label-secondary d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0">Edit Workflow State Permission</h5>
...
<form id="frm" class="form-validate">
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <div class="form-group row mb-4">
                ...
                <div class="col-md-4">
                    <select class="select2 form-select form-select-md" id="state_id" name="state_id" disabled>
                        @foreach($workflowStates as $workflowState)
                            <option value="{{ $workflowState->id }}" {{ old('state_id', $permission->state_id) == $workflowState->id ? 'selected' : '' }}>
                                {{ $workflowState->name }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="form-group row mb-4">
                ...
                <div class="col-md-4">
                    <select class="select2 form-select form-select-md" id="member_type_id" name="member_type_id" required>
                        @foreach($memberTypes as $memberType)
                            @if(in_array($memberType->id, $selectedMembers))
                                <option value="{{ $memberType->id }}" {{ old('member_type_id', $permission->member_type_id) == $memberType->id ? 'selected' : '' }}>
                                    {{ $memberType->name }}
                                </option>
                            @endif
                        @endforeach
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <div class="form-group row mb-4 align-items-center">
                ...
                <div class="col-md-9">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="can_edit_state" id="can_edit_state" value="1" onclick="toggleActive(this)" {{ $permission->can_edit_state ? 'checked' : '' }}>
                    </div>
            ...
            <div class="form-group row mb-4 align-items-center">
                ...
                <div class="col-md-9">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="can_edit_attribute" id="can_edit_attribute" value="1" onclick="toggleActive(this)" {{ $permission->can_edit_attribute ? 'checked' : '' }}>
                    </div>
            ...
            <div class="form-group row mb-4 align-items-center">
                ...
                <div class="col-md-9">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="can_upload" id="can_upload" value="1" onclick="toggleActive(this)" {{ $permission->can_upload ? 'checked' : '' }}>
                    </div>
            ...
            <div class="form-group row mb-4 align-items-center">
                ...
                <div class="col-md-9">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="can_download" id="can_download" value="1" onclick="toggleActive(this)" {{ $permission->can_download ? 'checked' : '' }}>
                    </div>
            ...
            <div class="form-group row mb-4 align-items-center">
                ...
                <div class="col-md-9">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="can_comment" id="can_comment" value="1" onclick="toggleActive(this)" {{ $permission->can_comment ? 'checked' : '' }}>
                    </div>
    ...
    <div class="card timestampable-section mb-3">
        <div class="card-header">
            <h6>Timestampable</h6>
        </div>
        <div class="card-body">
            <div class="form-group row mb-2">
                ...
                <div class="col-md-9">
                    <input type="text" class="form-control" name="inp[updated_by]" id="updated_by" value="{{ old('updated_by', $permission->updated_by ?? '') }}" data-rule-required="true" readonly>
                </div>
            </div>
            <div class="form-group row mb-2">
                <label class="col-md-3 col-form-label">{{ __('common.updated_at') }}</label>
                <div class="col-md-9">
                    <input type="text" class="form-control" name="inp[updated_at]" id="updated_at" value="{{ old('updated_at', $permission->updated_at ?? '') }}" data-rule-required="true" readonly>
                </div>
            </div>
        </div>
    </div>
