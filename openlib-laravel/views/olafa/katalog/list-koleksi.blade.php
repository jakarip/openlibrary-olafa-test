                ...
                <div class="col-12">
                    <div class="row g-3">
                        ...
                        <div class="col-12 col-sm-6 col-lg-12">
                            ...
                            <select id="status" class="select2 form-select form-select-md" multiple>
                            </select>
                        </div>
                        <div class="col-12 col-sm-6 col-lg-12">
                        ...
                        <div class="col-12 col-sm-6 col-lg-3">
                            <label for="origination" class="form-label">Asal Penerimaan:</label>
                            <select id="origination" class="select2 form-select form-select-md">
                                <option value="" selected disabled>Pilih Asal Penerimaan</option>
...
<script>
let dTable = null;
let url = '{{ url('olafa/katalog/list-koleksi') }}';
...
$(function(){
    ...
    var statusOptions = [
        ...
        { id: 4, name: 'Hilang' },
        { id: 5, name: 'Expired' },
        { id: 6, name: 'Hilang Diganti' },
        { id: 7, name: 'Sedang Diproses' },
        { id: 8, name: 'Cadangan' },
        { id: 9, name: 'Weeding' }
    ];
