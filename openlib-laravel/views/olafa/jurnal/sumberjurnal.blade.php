...
@section('title', 'Jurnal Nasional Terakreditasi')
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-transparent">
                <div class="modal-title"><i class="ti ti-forms me-2"></i> Form Sumber Jurnal Nasional</div>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" name="inp[title_name]" id="title_name"></input>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label class="col-md-3 col-form-label">Sinta Level</label>
                                <div class="col-md-9">
                                    <select class="select2 form-select form-select-lg" name="inp[sinta_level]" id="sinta_level" >
...
<div class="modal fade" id="frmbox_subject" tabindex="-1" role="dialog" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-transparent">
                <div class="modal-title"><i class="ti ti-forms me-2"></i> Form Journal Subject</div>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
...
let url = '{{ url('olafa/sumber-jurnal')}}';
...
$(function() {
    dTable = $('#table').DataTable({
        ...
        columns: [  
            { data: 'title_name', name: 'title_name', orderable: false, searchable: true },
            { data: 'sinta_level', name: 'sinta_level', orderable: false, searchable: true , class: 'text-center'},
    ...
    $('.dtb').append(`<button class="btn btn-openlib-red btn-sm me-2" onclick="add()"><i class="ti ti-file-plus ti-sm me-1"></i> Sumber Jurnal </button>`)
});
    ...
    if ($('#frmbox_subject').is(':visible')) {
        ...
        $.ajax({
            ...
            success: function(e) {
                _reset(); 
                $('#id').val(e.id);
                $('#title_name').val(e.title_name);
                $('#subject_id').val(e.subject_id).trigger('change');
                $('#sinta_level').val(e.sinta_level).trigger('change');
                $('#link').val(e.link);
