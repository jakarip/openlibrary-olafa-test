...
class Booking2Model extends CI_Model {  
    ...
    public function member($data){
        return $this->mn->query("select * from telu8381_openlibrarys.member where LOWER(master_data_user) like '%$data%' or LOWER(master_data_fullname) like '%$data%' and status='1'  order by master_data_fullname");
    } 
