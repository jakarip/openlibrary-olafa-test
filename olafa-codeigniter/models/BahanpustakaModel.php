...
class BahanPustakaModel extends CI_Model {
	...
	{ 
		...
		select count(*) totalmk, sum(total_mk_book) mk, sum(buku) judul, sum(buku_fisik) judul_fisik from (
		select *, 
		CASE  WHEN buku='0' THEN '0' ELSE '1' END as book, 
		CASE  WHEN buku_fisik='0' THEN '0' ELSE '1' END as book_fisik,
		CASE  WHEN (buku='0' and buku_fisik='0') THEN '0' ELSE '1' END as total_mk_book
		from (
