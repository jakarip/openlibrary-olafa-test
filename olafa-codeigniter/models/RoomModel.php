...
class RoomModel extends CI_Model {  
	...
	{
		return $this->db->query("select * from telu8381_room.room_gallery where rg_id='$id'");
	} 
	
	
	function getimagebyroomid($id)
	{
		return $this->db->query("select * from telu8381_room.room_gallery where rg_room_id='$id'");
	} 
