<?php
class Participant_Achievement_Model extends CI_Model
{
	
	private $table = 'participant_achievement';
	private $id    = 'pa_id';
	...
	**/
    ...
    function getbyparticipant($id)
    {
        $this->db->where('pa_id_participant', $id);
        return $this->db->get($this->table);
    }
}
?>