...
class Download extends CI_Controller 
{
	...
	public function list_data($id){
		$temp = $this->um->listCatalog($id)->result();

		foreach($temp  as $row){
			echo " Judul : ".$row->judul."<br>";
			echo " No : ".$row->kat."<br>";
			echo " Jenis : ".$row->jeniskatalog."<br>";
			echo " Klasifikasi : ".$row->cckode."<br>"; 
			echo " Subjek : ".$row->subjek."<br>"; 
			echo " Author : ".$row->author." "; 
			echo " Editor : ".$row->editor."<br>"; 
			echo " Penerbit : ".$row->publisher_name."<br>";  
			echo " Rak : ".$row->rak." "."<br>";
			echo " Lokasi : ".$row->lokasi."<br>"; 
			echo " Link : https://openlibrary.telkomuniversity.ac.id/home/catalog/id/".$row->id."/".$this->slugify($row->judul).".html <br><br><br><br>"; 
