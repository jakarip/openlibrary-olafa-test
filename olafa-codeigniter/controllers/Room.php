...
class Room extends CI_Controller {
    ...
    public function ajax_data(){
		...
		$colOrder 	= array(null,'room_name','room_min','room_max','room_description','room_activate',null); //set column field database for datatable orderable
		$colSearch 	= array('room_name','room_min','room_max','room_description','room_activate'); //set column field database for datatable
	...
	public function ajax_image()
	{
		...
		$table 		= "select * from telu8381_room.room_gallery left join telu8381_room.room on room_id=rg_room_id"; 
