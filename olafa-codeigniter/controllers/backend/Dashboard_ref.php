...
class Dashboard_ref extends CI_Controller 
{
	...
	{
		$data['view'] 			= 'backend/dashboard_ref/index';
		$data['title']			= 'Dashboard Affiliate';		
		...
		$data['participant']  	= $this->Dashboard_Model->get_dashboard_affiliate()->row();
