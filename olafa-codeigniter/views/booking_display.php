        ...
        <div class="panel">  
            <div class="panel-content pagination2"> 
				<div class="row content_button"> 
					<form id="search" name="search" method="post" action="index.php/bookingdisplay/display">
					<div class="col-lg-2"><label><?php echo getLang('choose_date'); ?></label></div>
					<div class="col-lg-2" >
		...
		<div class="modal-content" > 
		  <div class="modal-body" style="background-image:url('tools/images/poster.jpeg');background-repeat: no-repeat;height:50%;color:#fff;text-align:center">
			...
			<button type="button" class="btn btn-danger" data-dismiss="modal">CLOSE</button>
				...
				<br>
				<br> 
				<span style="font-size:40px;"><b>Kuesioner Kepuasan Pengunjung<br> Perpustakaan Open Library</b></span><br><br><br>
				...
				<span style="font-size:25px;"><a style="color:#fff;text-decoration: underline;" href="http://bit.ly/KuesionerTelUOpenlibrary2019" target="_blank">http://bit.ly/KuesionerTelUOpenlibrary2019</a> </span><br><br>
...
<div id="poster" class="modal fade " role="dialog">
	<div class="modal-dialog" style="width:35% !important">
		...
		<div class="modal-content" > 
			<div class="modal-body" style="background-color:#FFF;background-repeat: no-repeat;height:30%;color:#fff;">
					<div style="text-align:right;">
					<button type="button" class="btn btn-default" data-dismiss="modal">close</button>
					</div>   
				<div style="background-color:#FFF;background-repeat: no-repeat;height:30%; text-align:center""> 
					<img src="/images/poster.jpeg" width="100%"><br>
				</div>
				
				<!--<br>Silahkan memanfaatkan periode trial Scopus ini sampai dengan tanggal 19 April 2019<br>Demikian disampaikan, semoga bermanfaat.<br> 
<br>Salam Literasi</p> -->
		<!--</div> 
	</div>
	</div>   
...
$(document).ready(function(){ 
	...
	$("#schedule").timeSchedule({
        ...
        timeLineY:135,       // height(px)
        verticalScrollbar:20,   // scrollbar (px)
        dataWidth:120,		// data width
		...
		click: function(node,data){ 
			$.ajax({
				url : 'index.php/bookingdisplay/detail',
				type: "POST",
				data: {
					id : data.data.id
				},
...
function gallery(id) { 
	...
	$("#ajaxFancyBox").load("index.php/bookingdisplay/gallery/"+id, function() {                    
