...
<table width="100%">
	<tr>
		<td colspan="3"><h3>Thank you for register Telkom University Open Library</h3></td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="3">Your account has been successfully verified and you can login using the following details : </td>
	</tr>
	<tr>
	...
	<tr>
		<!-- <td colspan="3">Silahkan login untuk berlangganan menjadi anggota Telkom University<br>
