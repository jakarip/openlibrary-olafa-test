                            ...
                            <div class="x_panel">
                                <div class="x_title">
									<table width="100%" border="0" cellpadding="2" cellspacing="2">
										<tr><td rowspan="4" width="80px"><button onclick="window.location.href='index.php/sms/grup'" class="btn btn-danger" type="button">Back</button></td></tr>
										<tr >
											<td width="220px" style="border-left:1px solid;padding-left:5px;">Nama Grup</td>
											<td width="10px">:</td>
											<td><?php echo $pengajuan->sg_name ?></td>  
										</tr> 
										<tr >
                                        ...
                                        <tbody>
                                             <?php  
												...
												<tr class="<?php echo $style?>">  
													...
													<td class=""><?php echo  ucwords(strtolower($row['id'])) ?></td> 
...
$(document).ready(function () {
	...
	$('body').on('click', '#tambah', function(){
		...
		$.ajax({
			url:'index.php/pengadaan/addmember',
			global:false,
			type:'post',
			data : {id : $( "#tambah" ).val()},
			dataType: "html",
...
function Delete(id)
{
	if(confirm(' ID = '+id+'\n Apakah anda yakin akan menghapus data tersebut ?')) {
		$.ajax({
			url:'index.php/sms/delPengajuanDetail',
			global:false,
			type:'post', 
			data: ({id : id}),
			async:false,
			success: function() { window.location='index.php/sms/grupdetail/<?php echo $pengajuan->sg_id ?>' }
		});
	}
}
...
{ 
	$.ajax({
		url:'index.php/sms/editGrupDetail',
		global:false,
		type:'post',
		data: ({id : id}),
		dataType: "json",
