            ...
            <div class="content">
                ...
                <div class="tabbable panel login-form width-400">
                    <ul class="nav nav-tabs nav-justified"> 
                        <li class="active"><a href="#basic-tab1" data-toggle="tab"><h6><i class="icon-user-plus position-left"></i> Register</h6></a></li> 
                    </ul>

                    <div class="tab-content panel-body"> 
						<div class="tab-pane fade in active" id="basic-tab1">
                            <form action="index.php/register/member" method="post" id="frm3" enctype="multipart/form-data"> 
                                ...
                                <span class="help-block text-center no-margin">Sudah memiliki Akun ? <strong><a  href="/">Silahkan Login</a></strong></span>
                            </form>
                        </div>
                    </div>
                </div>
