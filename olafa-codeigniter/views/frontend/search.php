...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content"> 
                <!-- Tabbed form -->
                <div class="tabbable panel" style="min-height:400px;">
                    <ul class="nav nav-tabs nav-justified" style="background-color:#10528B;"> 
                        <li class="active"><a href="#basic-tab1" data-toggle="tab"><strong><h2 style="color:#FFF"><i class="icon-search4 position-left"></i> Integrated Search Engine</h2></a><strong></li> 
                    </ul>
				
                    <div class="tab-content panel-body"> 
						
						<div class="tab-pane fade in active" id="basic-tab1"> 
							<div style="font-size: 14px;"><strong>Pencarian terintergasi untuk koleksi yang ada di repository Perpustakaan BPPT. Terdiri dari Digilib BPPT, E-Paper BPPT, E-Jurnal BPPT, Produk Hukum BPPT, dan KMS BPPT : </strong></div><br><br>
...
<script async src="https://cse.google.com/cse.js?cx=5cbaaac86f8f7cb37"></script>
