...
<table width="100%">
	<tr>
		<td colspan="3"><h1>Thanks for signing up!</h1></td>
	</tr>
	<tr>
		<td colspan="2"><img style="vertical-align:middle;" src="https://openlibrary.telkomuniversity.ac.id/olafa/tools/images/logo.png" width="90"></td>
		<td><span style="font-weight:bold;font-size:24px;color:#c9302c">Telkom University<br>Open Library</span></td>
	</tr>
	<tr>
		<td colspan="3">&nbsp;</td>
	</tr>
	<tr>
		<td colspan="3">Your account has been created, you can login with the following credentials after you have activated your account by pressing the url below</td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="3">Please click this link to activate your account	:</td>
	</tr>
	<tr>
