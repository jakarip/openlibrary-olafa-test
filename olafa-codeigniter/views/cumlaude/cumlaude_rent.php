			...
			<table class="dt_table1 table table-striped table-bordered table-hover">
				<thead>
					<tr>
						...
						<th width="14%"><?php echo getLang("No. Eksemplar") ?></th>  
						<th width="15%"><?php echo getLang("Tanggal Pinjam") ?></th> 
						<th width="15%"><?php echo getLang("Tanggal Kembali") ?></th> 
					</tr>
				</thead>
				<tbody>
				</tbody>
...
function dt_table(id) {
	table = $('.dt_table1').DataTable({ 
        ...
        "ajax": {
            "url": 'index.php/cumlaude/ajax_rent',
            "type": "POST",
			"data" : {
				id : id
			}
