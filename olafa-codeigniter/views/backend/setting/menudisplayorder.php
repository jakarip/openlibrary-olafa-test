...
$(document).ready(function() {
    table = $('#table').DataTable({        
        ...
        "order": [],   
        "ajax": {
            "url": 'index.php/backend/setting/ajax_menudisplayorder',
            "type": "POST"
        }, 
        "columnDefs": [
			{ 
...
function edit(id) {
    ...
    reset();
    $.ajax({
        url : 'index.php/backend/setting/edit_menudisplayorder',
        type: "POST",
		data: {
				id :id
			},
...
function save() { 
	$.ajax({
		url : 'index.php/backend/setting/update_menudisplayorder',
		type: "POST",
...
function detail(id) {
	...
	$.ajax({
		url : 'index.php/backend/setting/get_usergroup_menu',
		type: "POST",
		data: {
			id :id
		},
...
function detail_save() { 
	...
	if (total==0) info_alert('warning','<?php echo getLang("min_selected_one_user_group")?>');
		...
		$.ajax({
			url : 'index.php/backend/setting/set_usergroup_menu',
			type: "POST",
