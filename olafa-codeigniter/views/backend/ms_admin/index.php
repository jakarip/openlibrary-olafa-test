                ...
                <div class="modal-body">
                    <div class="box-body" style="padding-bottom:0px">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-9">
                            	<input type="text" class="form-control input-sm" name="inp[admin_name]" id="admin_name" required>
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
                            <label for="pus_name" class="col-sm-3 control-label">Username</label>
                            <div class="col-sm-9">
                            	<input type="text" class="form-control input-sm" name="inp[admin_username]" id="admin_username" required>
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
...
var tb 		= '#table';      
var baseurl = '<?= y_url_admin() ?>/ms_admin';
