...
<div class="panel panel-default flat">
	...
	<form id="frm2" method="post" action="<?= y_url_admin() ?>/simulation/step3" onSubmit="return confirm('Apakah anda yakin untuk melanjutkan proses ini. Silahkan cek kembali hasil upload data. Proses tidak dapat di ulang.')">
