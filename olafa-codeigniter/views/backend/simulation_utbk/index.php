<div class="panel panel-default flat">
    	...
    	<div class="steps clearfix">
        	<ul role="tablist">
                ...
                <li role="tab" class="disabled" aria-disabled="true">
                	<a href="<?= y_url_admin() ?>/simulation_utbk/step2" aria-controls="steps-uid-0-p-1"><span class="number">2</span> Upload File Hasil Simulasi</a>
                </li>
                <li role="tab" class="disabled" aria-disabled="true">
    ...
    <div class="panel-body">
        ...
        <div class="alert alert-warning no-border text-center mt-20 mb-20">
            <?php if($count > 0) { ?>
            <a href="<?= y_url_admin() ?>/simulation_utbk/step1_download_excel" style="text-transform:uppercase"><span class="text-semibold">Download File Excel Simulasi Kelulusan</span></a>
            <?php } else { ?>            
    ...
    <div class="panel-footer">
    	<div class="text-center">
            ...
            <a href="<?= y_url_admin() ?>/simulation_utbk/step2" class="btn btn-primary btn-xs heading-btn">Lanjutkan<i class="icon-arrow-right13 position-right"></i></a>
    	</div>
    </div>
</div>
