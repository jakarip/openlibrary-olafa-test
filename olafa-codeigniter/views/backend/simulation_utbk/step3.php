<div class="panel panel-default flat">
    	...
    	<div class="steps clearfix">
        	<ul role="tablist">
            	<li role="tab" class="first done" aria-disabled="false" aria-selected="true">
                	<a href="<?= y_url_admin() ?>/simulation_utbk" aria-controls="steps-uid-0-p-0"><span class="number">1</span> Download File Simulasi</a>
                </li>
    ...
    <div class="panel-footer">
    	<div class="text-center">
            <a href="<?= y_url_admin() ?>/simulation_utbk" class="btn btn-primary btn-xs heading-btn"><i class="icon-loop3 position-left"></i>Ulangi Proses</a>
    	</div>
    </div>
</div>
