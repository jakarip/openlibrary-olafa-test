                ...
                <div class="modal-body">
                    <div class="box-body" style="padding-bottom:0px">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-9">
                            	<input type="text" class="form-control input-sm" name="inp[discount_title]" id="discount_title" required>
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
                            <label for="pus_name" class="col-sm-3 control-label">Kode Diskon</label>
                            <div class="col-sm-9">
															<input type="text" class="form-control input-sm" name="inp[discount_code]" id="discount_code" required>
                        		</div>
                        </div>
                        <div class="form-group form-group-sm">
                            <label for="pus_name" class="col-sm-3 control-label">Tanggal Awal</label>
                            <div class="col-sm-9">
                            	<input type="text" class="form-control input-sm" name="inp[discount_start_date]" id="discount_start_date" required>
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
                            <label for="pus_name" class="col-sm-3 control-label">Tanggal Akhir</label>
                            <div class="col-sm-9">
                            	<input type="text" class="form-control input-sm" name="inp[discount_end_date]" id="discount_end_date" required>
                            </div>
                        </div> 
                    </div><!-- /.box-body -->
                </div>
...
var tb 		= '#table';      
var baseurl = '<?= y_url_admin() ?>/discount';
...
function add()
{ 
	$('#frmbox #discount_start_date').daterangepicker({ 
	...
	$('#frmbox #discount_end_date').daterangepicker({ 
		singleDatePicker: true,
		locale: {
			format: 'DD-MM-YYYY'
		}
