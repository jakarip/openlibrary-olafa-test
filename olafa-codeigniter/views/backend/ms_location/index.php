<div class="panel panel-default flat">
    <table class="table table-bordered table-striped table-hover" id="table">
        <thead>
            <tr>
                <th width="35%">Nama Lokasi</th>
                <th width="40%">Alamat Lokasi</th> 
                ...
                <div class="modal-body">
                    <div class="box-body" style="padding-bottom:0px">
                        <div class="form-group form-group-sm">
                            <label for="pus_name" class="col-sm-3 control-label">Nama Lokasi</label>
                            <div class="col-sm-9">
                            	<input type="text" class="form-control input-sm" name="inp[location_name]" id="location_name" required>
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
                            <label for="pus_name" class="col-sm-3 control-label">Alamat Lokasi</label>
                            <div class="col-sm-9">
								<input type="text" class="form-control input-sm" name="inp[location_address]" id="location_address" required> 
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
                            <label for="pus_name" class="col-sm-3 control-label">Kec / Kab / Prov</label>
                            <div class="col-sm-9">
                            	<select class="form-control input-sm" name="inp[location_id_kec]" id="location_id_kec" required></select>
                            </div>
                        </div> 
                    </div><!-- /.box-body -->
                </div>
...
var tb 		= '#table';      
var baseurl = '<?= y_url_admin() ?>/ms_location';
...
{		
	$.ajax({
		...
		success: function(e) {
			...
			$('#location_id_kec').append('<option value="'+e.kec_id+'" selected="selected">Kec. '+e.kec_name+', '+e.kec_kab+', Prov. '+e.kec_prov+'</option>');
			$('#location_id_kec').trigger('change');
			$('#frmbox').modal({keyboard: false, backdrop: 'static'});
		},
		error : function() {
