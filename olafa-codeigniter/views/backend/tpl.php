				...
				<ul class="nav navbar-nav">
                	<li class="dropdown dropdown-user">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right"> 
														<li><a href="index.php/<?= y_url_admin() ?>/login/logout"><i class="icon-switch2"></i> Logout</a></li>
                        </ul>
            		</li>
            	</ul>
            </div>
								...
								<div class="media-right media-middle">
									<ul class="icons-list">
										<li>
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right"> 
                                                <li><a href="<?= y_url_admin() ?>/login/logout"><i class="icon-switch2"></i> Logout</a></li>
                                            </ul>
										</li>
									</ul>
								</div>
					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion"> 
									<li><a href="index.php/<?= y_url_admin() ?>/member"><i class="icon-people"></i> <span>Data Pendaftar
									<li><a href="index.php/<?= y_url_admin() ?>/subscribe"><i class="icon-cash4"></i> <span>Data Berlangganan 
