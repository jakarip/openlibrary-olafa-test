    ...
    <table class="table table-bordered table-striped table-hover" id="table">
        <thead>
            <tr>
                ...
                <th width="40%">Nama Komponen Biaya</th>
                <th width="15%">Virtual Account</th>
                <th width="10%">(n) Biaya</th>
                <th width="15%">&nbsp;</th>
            </tr>
        </thead>
        <tbody></tbody>
                ...
                <div class="modal-body">
                    <div class="box-body" style="padding-bottom:0px">
                        <div class="form-group form-group-sm">
                            <label class="control-label">Nama Komponen Biaya</label>
                            <div>
                            	<input type="text" class="form-control input-sm" name="inp[component_name]" id="component_name" required>
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
                            <label class="control-label">Virtual Account</label>
                            <div>
                            	<input type="text" class="form-control input-sm" name="inp[component_bank]" id="component_bank" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="inp[component_custom]" id="component_custom" value="1">
                                    (n) Biaya (Biaya yang dapat di isi jumlah <strong>n</strong> oleh calon mahasiswa)
                                </label>
                            </div>
                        </div>
                    </div><!-- /.box-body -->
...
var tb 		= '#table';      
var baseurl = '<?= y_url_admin() ?>/ms_component';
