		...
		<div class="panel-content pagination2">
			<form id="form" class="form-horizontal" action="" method="post">
				<div class="form-group">
					...
					<div class="col-sm-5"> 
						<select name="status" id="status" class="form-control select2"  multiple="multiple" style="width:100% !important"> 
				...
				<div class="form-group">
					...
					<div class="col-sm-5"> 
						<select name="type" id="type" class="form-control select2"  multiple="multiple" style="width:100% !important"> 
