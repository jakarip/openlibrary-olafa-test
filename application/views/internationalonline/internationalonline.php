                ...
                <table id="table-supplier" class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th width="45%"><?php echo getLang('journal'); ?></th>
                            <th width="40%"><?php echo getLang('URL'); ?></th> 
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10 prepend-icon">
                        <input class="form-control" type="text" name="inp[io_name]" id="io_name" placeholder="<?php echo getLang('name'); ?>" required>
				...
				<div class="form-group">
					...
					<div class="col-sm-10 prepend-icon">
						<input class="form-control" type="text" name="inp[io_url]" id="io_url" placeholder="<?php echo getLang('URL'); ?>" required>
						<i class="fa fa-file-o"></i>
					</div>
				</div>
            </div>
...
$(document).ready(function(){
	table = $('#table-supplier').DataTable({     
		...
		"order": [],  
		"ajax": {
			"url": "<?php echo site_url('index.php/internationalonline/ajax_dt')?>",
			"type": "POST"
		}, 
		"columnDefs": [
			{ 
...
function edit(id){
  ...
  reset();
	  ...
	  $.ajax({
		url : "<?php echo site_url('index.php/internationalonline/edit')?>",
		type: "POST",
		data : {
			id : id
		},
...
function save(){
	var url;
	if(save_method == 'add'){
		url = "<?php echo site_url('index.php/internationalonline/insert')?>";
	}else{
		url = "<?php echo site_url('index.php/internationalonline/update')?>";
	}
