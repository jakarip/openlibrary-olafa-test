					...
					<div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel"> 
                                <div class="x_content">
                                    <br />
                                    <form id="demo-form2" data-parsley-validate method="post" action="index.php/pengadaan/addNodinDetailDb" class="form-horizontal form-label-left">
										<input type="hidden" id="id" name="id" value="<?php echo $pengajuan->nd_id ?>">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10 col-sm-10 col-xs-12">
                                               <input type="text" disabled="disabled" value="<?php echo $pengajuan->nd_nomor ?>" id="nomor" name="nomor" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                ...
                                                <button type="button" class="btn btn-primary merah" onclick="window.location='index.php/pengadaan/nodin'">Cancel</button>
                                            </div>
...
<script language="javascript" type="text/javascript">
	$(document).ready(function () {
		...
		$('body').on('click', '#tambah', function(){
			...
			$.ajax({
				url:'index.php/pengadaan/addnodinlist',
				global:false,
				type:'post',
				data : {id : $( "#tambah" ).val()},
				dataType: "html",
		...
		$('body').on('focus', '.judul', function(){
			...
			$('#temp').val(str);
			$.ajax({
				url:'index.php/pengadaan/nodindtcontent', 
				type:'post',
				data : $('#demo-form2').serialize(),
				dataType: "html",
				async:false,
				success: function(result) { 
					$('.editNodin #example').dataTable().fnClearTable();
					$( "#dtcontent" ).html(result);
				}
			});
			
			var oTable = $('.editNodin #example').dataTable({
				"oLanguage": {
			...
			$(".editNodin tfoot input").keyup(function () {
				/* Filter on the column based on the index of this element's parent <th> */
				oTable.fnFilter(this.value, $("tfoot th").index($(this).parent()));
			});
			$(".editNodin tfoot input").each(function (i) {
				asInitVals[i] = this.value;
			});
			$(".editNodin tfoot input").focus(function () {
				if (this.className == "search_init") {
					this.className = "";
					this.value = "";
				}
			});
			$(".editNodin tfoot input").blur(function (i) {
				if (this.value == "") {
			...
			$('body').on('click', '.editNodin tbody tr', function(){
