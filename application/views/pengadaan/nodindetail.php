                            ...
                            <div class="x_panel">
                                <div class="x_title">
									<table width="100%" border="0" cellpadding="2" cellspacing="2">
										<tr><td rowspan="3" width="80px"><button onclick="window.location.href='index.php/pengadaan/nodin'" class="btn btn-danger" type="button">Back</button></td></tr>
										<tr >
											<td width="220px" style="border-left:1px solid;padding-left:5px;">Nomor Nota Dinas</td>
											<td width="10px">:</td>
											<td><?php echo $pengajuan->nd_nomor ?></td> 
											<td align="right" rowspan="3"><a href="index.php/pengadaan/addnodindetail/<?php echo $pengajuan->nd_id ?>"><button type="button" class="btn btn-primary hijau">Tambah List</button></td>
										</tr> 
										<tr >
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="editform" data-parsley-validate method="post" action="index.php/pengadaan/editNodinDetailDb" class="form-horizontal form-label-left">
				<input type="hidden" id="id" name="id">
				<input type="hidden" id="idparent" name="idparent" value="<?php echo $pengajuan->nd_id ?>">
...
function Delete(id)
{
	if(confirm(' ID = '+id+'\n Apakah anda yakin akan menghapus data tersebut ?')) {
		$.ajax({
			url:'index.php/pengadaan/delNodinDetail',
			global:false,
			type:'post', 
			data: ({id : id}),
			async:false,
			success: function() { window.location='index.php/pengadaan/nodindetail/<?php echo $pengajuan->nd_id ?>' }
		});
	}
}
...
{ 
	$.ajax({
		url:'index.php/pengadaan/editNodinDetail',
		global:false,
		type:'post',
		data: ({id : id}),
		dataType: "json",
		...
		success: function(result) {   
			...
			$('#editform #eks').val(result.pd_eks_awal);
		}
	});
}
