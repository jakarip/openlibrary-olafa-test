				...
				<table class="table table-striped responsive-utilities jambo_table bulk_action">
					<tbody>
						...
						foreach ($data[$i] as $row) {
							...
							$url   = "http://localhost/openlibrary-olafa/pustaka/" . $row->cat_id . "/" . $title . ".html";
						?>
							<tr class="<?php echo $style ?>">
								...
								<td width="50%"><?php
												...
												echo "<a href='http://localhost/openlibrary-olafa/knowledgeitem/" . $row->cat_id . "/available.html'>Total " . $row->eks . " Koleksi</a><br>";
												echo $url;
												?></td>
								<td width="35%"><?php
