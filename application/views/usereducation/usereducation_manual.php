		...
		<div class="panel-content pagination2">
			<form id="form" class="form-horizontal"> 
				<div class="form-group">  
					<label class="col-sm-3 col-sm-offset-3 control-label">Nama Lengkap <span class="required">*</span></label>
					<div class="col-sm-3">
						<input type="text"  class="form-control" name="inp[useredu_name]" id="useredu_name" required placeholder="Nama Lengkap"> 
					</div> 
				</div> 
				<div class="form-group">
					<label class="col-sm-3 col-sm-offset-3 control-label">Pilih Prodi <span class="required">*</span></label>
					<div class="col-sm-3">
						<select name="inp[useredu_prodi]" id="useredu_prodi" class="form-control" required>
							<?php
				...
				<div class="form-group">
					<label class="col-sm-3 col-sm-offset-3 control-label">NIM</label>
					<div class="col-sm-3">
						<input type="text"  class="form-control" name="inp[useredu_nim]" id="useredu_nim" placeholder="NIM"> 
					</div> 
				</div> 
				<div class="form-group">
					<label class="col-sm-3 col-sm-offset-3 control-label">No. HP</label>
					<div class="col-sm-3">
...
function dt_table() {
	table = $('.dt_table1').DataTable({ 
        ...
        "ajax": {
            "url": 'index.php/usereducationmanual/ajax_index',
            "type": "POST" 
        }, 
        "columnDefs": [
			{ 
...
function registrasi(){ 
	if (form.valid()) {
		$.ajax({
			url : 'index.php/usereducationmanual/add',
			type: "POST",
			data: form.serialize(),
			beforeSend : function() {
				showLoading();
