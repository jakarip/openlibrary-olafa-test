...
<div class="body-container">
	...
	<div class="navbar navbar-inverse" style="z-index: 27;background-image:url(assets/images/backgrounds/bg.png); margin-bottom:0px !important;background-color: #c62828;">
            ...
            <ul class="nav navbar-nav navbar-right">
				<li class="dropdown dropdown-user">
					<a class="dropdown-toggle" data-toggle="dropdown">
						<img src="http://demo.interface.club/limitless/bs3/Template/global_assets/images/demo/users/face11.jpg" alt="">
						<span><?= y_greeting('id', 'yes'); ?>, Calon Mahasiswa</span>
						<i class="caret"></i>
					</a>
        ...
        <div class="navbar-collapse collapse" id="navbar-second-toggle">
            <ul class="nav navbar-nav">
                <li class="<?=($view=='frontend/dashboard/index'?'active':'')?>">
									<a href=""><i class="icon-display4 position-left"></i> Pembelian Pin</a></li>
                <li class="<?=($view=='frontend/questionnaire/index'?'active':'')?>"><a href="questionnaire"><i class="icon-question4 position-left"></i> Kuesioner</a></li>
                <li class="<?=($view=='frontend/pendaftaran/biodata'?'active':'')?>"><a href="pendaftaran/biodata"><i class="icon-profile position-left"></i> Biodata</a></li>
                <li class="<?=($view=='frontend/pin/index'?'active':'')?>"><a href="pin"><i class="icon-file-text2 position-left"></i> Data Pendaftaran</a></li>
            </ul>
        </div>
    </div>
    <!-- End Second navbar -->
