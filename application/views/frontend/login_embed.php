            ...
            <div class="content" style="padding: 0px !important;">
                ...
                <div class="tabbable panel">
                    <ul class="nav nav-tabs nav-justified">
                        <li class="active"><a href="#basic-tab1" data-toggle="tab"><h6><i class="icon-user-lock position-left"></i> Login Pendaftar</h6></a></li>
                        <li><a href="#basic-tab2" data-toggle="tab"><h6><i class="icon-user-plus position-left"></i> Buat Akun Baru</h6></a></li>
                    </ul>

                    <div class="tab-content panel-body">
                        <div class="tab-pane fade in active" id="basic-tab1">
                            <form action="login/exe/embed" method="post" id="frm">
                                <div class="text-center">
                                    <!--<img src="cdn/environment/logo.png" height="70" style="height: 70px">-->
                                    <h5 class="content-group"><?= strtoupper($iset['website_name']) ?> <small class="display-block">Masukkan Username dan Password Peserta Anda</small></h5>
                                </div>
                        ...
                        <div class="tab-pane fade" id="basic-tab2">
                            <form action="login/reg" method="post" id="frm2" onsubmit="if(grecaptcha.getResponse() == '') { alert('Centang Terlebih Dahulu I\'m not a robot'); return false; }">
                                <div class="text-center">
                                    <!--<img src="cdn/environment/logo.png" height="70" style="height: 70px">-->
                                    <h5 class="content-group"><?= strtoupper($iset['website_name']) ?> <small class="display-block">Masukkan Identitas Peserta Anda</small></h5>
                                </div>
                                ...
                                <div class="form-group has-feedback has-feedback-left">
                                    ...
                                    <span class="help-block">Disarankan domain email yang digunakan adalah @gmail.com</span>
                                </div>

                                <div class="form-group has-feedback has-feedback-left">
                                    <input type="text" name="inp[par_nik]" id="par_nik" class="form-control" placeholder="Nomor Induk Kependudukan (NIK)" required="required" minlength="5" maxlength="18" value="<?=$phone?>">
                                    <div class="form-control-feedback">
                                        <i class=" icon-user-card text-muted"></i>
                                    </div>
                                    <span class="help-block">Diambil dari E-KTP atau KK</span>
                                </div>

                                <div class="form-group has-feedback has-feedback-left">
                                    <input type="text" name="referral_code" id="referral_code" class="form-control" placeholder="Kode Diskon" minlength="6" maxlength="25">
                                    <div class="form-control-feedback">
                                        <i class=" icon-mobile text-muted"></i>
                                    </div>
                                    <span class="help-block">Dapat dikosongkan apabila tidak mempunyai Kode Diskon</span>
                                </div>
                                ...
                                <span class="help-block text-center no-margin">Sudah memiliki Akun ? <strong><a  href="javascript:show_login()">Silahkan Login</strong></span>
                            </form>
                        </div>
                    </div>
                </div>
