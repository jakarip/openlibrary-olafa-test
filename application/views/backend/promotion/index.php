                ...
                <div class="modal-body">
                    <div class="box-body" style="padding-bottom:0px"> 
                        <div class="form-group form-group-sm">
                            <label for="pus_name" class="col-sm-3 control-label">Text Promosi</label>
                            <div class="col-sm-9"> 
                            	<textarea class="form-control input-sm" name="inp[promotion_text]" id="promotion_text" required></textarea>
                            </div>
                        </div> 
                    </div><!-- /.box-body -->
                </div>
...
var tb 		= '#table';      
var baseurl = '<?= y_url_admin() ?>/promotion';
...
function copies(id)
{
	var copyText = document.getElementById("texter"+id);
