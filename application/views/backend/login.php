...
<body class="account separate-inputs boxed" data-page="login">
	...
	<div class="container" id="login-block">
		...
		<p class="account-copyright">
			<span>Copyright © 2016 </span><span><a href="http://www.creasoft.co.id" target="_blank">CREATIVE SOFTWARE SOLUTION</a></span>.<span>All rights reserved.</span>
		</p>
	</div>
...
$(document).ready(function(){ 
	...
	$('#submit-form').click(function(e) {
		...
		if (form.valid()) {
			...
			$.ajax({
				dataType	: "json",
				url			: 'backend/login/loginProcess',
				type		: 'post',
				data		: form.serialize(),
				beforeSend	: function(){
					l.start();
	...
	$.backstretch(["tools/assets/global/images/gallery/login.jpg"],
	{
		fade: 600,
		duration: 4000
	});
