<?php
class Ms_Faculty_Model extends CI_Model 
{
	
	private $table = 'ms_faculty';
	private $id    = 'faculty_id';
	...
	**/
	...
	{
		return $this->db->query("UPDATE ms_prodi a LEFT JOIN ".$this->table." b ON a.prodi_faculty_id = b.faculty_id
								 SET a.prodi_faculty = b.faculty_name
								 WHERE a.prodi_faculty_id = '$id'");
	}
}
?>