...
class InternationalFisik extends CI_Controller {
   ...
   function index() { 
		...
		$data['menu'] 	= 'internationalfisik/internationalfisik'; 
	...
	public function ajax_index()
	{
		...
		$table 		= "SELECT ki.id ids, title,publisher_name,isbn,published_year, count(ki.id) eks FROM knowledge_item ki LEFT JOIN knowledge_stock ks ON ki.id = ks.knowledge_item_id where ki.knowledge_type_id='44' group by ki.id order by ki.id";
