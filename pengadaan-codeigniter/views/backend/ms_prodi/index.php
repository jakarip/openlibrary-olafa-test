                ...
                <div class="modal-body">
                    <div class="box-body" style="padding-bottom:0px">
                        <div class="form-group form-group-sm">
                            <label for="pus_name" class="col-sm-3 control-label">Fakultas</label>
                            <div class="col-sm-9">
                            	<?= form_dropdown('faculty', $faculty, '', 'class="form-control input-sm select" id="faculty" required="true"') ?>
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
                            <label for="pus_name" class="col-sm-3 control-label">Program Studi (Prodi)</label>
                            <div class="col-sm-9">
                            	<input type="text" class="form-control input-sm" name="inp[prodi_name]" id="prodi_name" required>
                            </div>
                        </div>
                    </div><!-- /.box-body -->
                </div>
...
var tb 		= '#table';      
var baseurl = '<?= y_url_admin() ?>/ms_prodi';
...
{		
	$.ajax({
		...
		success: function(e) {
			...
			$('#faculty').val(e.prodi_faculty_id+'__'+e.prodi_faculty).trigger('change');
			$('#frmbox').modal({keyboard: false, backdrop: 'static'});
		},
		error : function() {
