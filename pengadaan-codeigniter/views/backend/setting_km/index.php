                ...
                <div class="modal-body">
                    <div class="box-body" style="padding-bottom:0px"> 
                        <div class="form-group form-group-sm">
                            <label for="pus_name" class="col-sm-3 control-label">Jenis KM</label>
                            <div class="col-sm-9">
								<?= form_dropdown('inp[km_type]', $km, '', 'class="form-control input-sm" id="km_type" required'); ?>
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
                            <label for="pus_name" class="col-sm-3 control-label">Tanggal</label>
                            <div class="col-sm-9">
                            	<input type="text" class="form-control input-sm" name="inp[km_date]" id="km_date" required>
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
                            <label for="pus_name" class="col-sm-3 control-label">Target KM</label>
                            <div class="col-sm-9">
                            	<input type="text" class="form-control input-sm km_target" name="inp[km_target]" id="km_target" required>
                            </div>
                        </div> 
                    </div><!-- /.box-body -->
                </div>
...
var tb 		= '#table';      
var baseurl = '<?= y_url_admin() ?>/setting_km';
...
$(document).ready(function() {	 
	...
	jQuery.validator.addClassRules("km_target", {
		required: true,
		number: true
	});
...
function add()
{ 
	$('#frmbox #km_date').daterangepicker({ 
