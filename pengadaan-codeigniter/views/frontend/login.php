                    ...
                    <div class="tab-content panel-body">
                        <div class="tab-pane fade in active" id="basic-tab1">
                            <form action="index.php/login/exe" method="post" id="frm">
                                ...
                                <div class="form-group" align="center">
                                    <a href="javascript:show()"><i class="icon-user-plus position-left"></i>Buat Akun Baru</a> <br><br>
                                    <a target="_blank" href="cdn/panduan_pendaftaran_keanggotaan_umum.pdf?1"><i class="icon-book3 position-left"></i>Panduan Pendaftaran Umum</a><br>
						...
						<div class="tab-pane fade" id="basic-tab2">
                            <form action="index.php/login/reg" method="post" id="frm3" enctype="multipart/form-data"> 
                                ...
                                <div class="form-group has-feedback has-feedback-left">
                                    <input type="text" name="inp[address]" id="address" class="form-control" placeholder="Alamat" required="required" value="<?=$address ?>">
                                    <div class="form-control-feedback">
