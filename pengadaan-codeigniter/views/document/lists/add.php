...
<div style="flex-direction: row!important;display: flex!important;justify-content: space-between;align-items: center">
    <h4>New Document</h4>
    <a href="https://openlibrary.telkomuniversity.ac.id/open/index.php/document" class="text-primary">New Document</a>
</div>
<?php
$session = $this->session->userdata('user_doc'); 
?>
<form name="frm" class="form-horizontal" id="frm" method="post" enctype="multipart/form-data" action="index.php/document/lists/save">
        ...
        <div class="row">   
            ...
            <div id="lecturer">
                <div class="form-group form-group-sm">
                    ...
                    <div class="col-sm-10">
                        <select name="inp[lecturer_id]" id="lecturer_id" class="form-control select2"><option value="">Pilih Dosen Pembimbing 1</option></select>
                    </div>
                </div> 
                <div class="form-group form-group-sm">
